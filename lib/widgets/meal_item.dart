          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Column(children: [
                  Text(meal.title,maxLines: 2, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis, softWrap: true, style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
                  SizedBox(height: 12,),
                  Row(mainAxisAlignment: MainAxisAlignment.center,
                  children:[
                    MealItemTrait(icon: Icons.schedule, label: '${meal.duration} min'),
                    SizedBox(width: 10,),
                    MealItemTrait(icon: Icons.work, label: meal.complexity.name[0].toUpperCase() + meal.complexity.name.substring(1)), //substring(1) gets you the string without the first character, name[0] gets you the first character
                    SizedBox(width: 10,),
